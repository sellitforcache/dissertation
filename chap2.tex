...
\caption{Partitioning schemes on the top with the resulting trees on the bottom. A BVH tree is on the left and a k-d tree is on the right. (courtesy WikiMedia commons)  \label{bvh_kd}}
\end{figure}
