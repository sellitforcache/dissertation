...
\label{NTE}
\begin{split}
\frac{\partial }{\partial t}\psi(\boldsymbol{\vec{r}},\boldsymbol{\hat{\Omega}},E,t) &+  \\
...
&+ \frac{1}{4\pi} \int_0^\infty  \int_{4\pi} \nu \chi(E) \Sigma_f(\boldsymbol{\vec{r}},E) \psi(\boldsymbol{\vec{r}},\boldsymbol{\hat{\Omega}},E,t) d\boldsymbol{\Omega}  dE\\
& + S_{\mathrm{external}}
\end{split}
 \end{equation}
