...
\begin{figure}[h!] 
  \centering
    \includegraphics[width=0.8\textwidth]{graphics/prelim_geom.eps}
     \caption{The 2D geometry of the scattering test \cite{cuda}. \label{prelim_geom} }
\end{figure}

\begin{figure}[h!] 
  \centering
    \includegraphics[width=0.8\textwidth]{graphics/prelim_speedup.eps}
     \caption{The 2D geometry of the scattering test \cite{cuda}. \label{prelim_speedup} }
\end{figure}

\begin{figure}[h!] 
  \centering
    \includegraphics[width=0.8\textwidth]{graphics/prelim_batches.eps}
     \caption{The 2D geometry of the scattering test \cite{cuda}. \label{prelim_batches} }
\end{figure}
