...
If the polar and azimuthal rotation angles, $\theta$ and $\phi$, respectively, are determined,  that the final velocities are known in the CM frame, they can be transformed back to the lab frame, as shown in \eqref{xformbackCM}, to give the final velocities there.
