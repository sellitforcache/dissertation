...
The codes seem to also be quite inflexible.  They can 
	...
	sorting, event-based did not use parallel sorting algorithms
...
WARP will read ACE-formatted data, perform all reaction types as prescribed by them, use a Serpent-like unionized energy grid to regularize data access, use an event-based transport algorithm with parallelized operations for sorts and reductions, use OptiX for general 3D geometry representation, and use a SOA for neutron history data.
