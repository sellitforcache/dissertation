...
The sampling scheme for this probability distribution shown in \eqref{law44samp}\cite{3rdsampler}\cite{openmc}, where $\xi_1$ and $\xi_2$ are two additional random numbers.  After $\mu$ is sampled, the outgoing energy value is sampled on an independent tabular distribution, which is the topic of the next subsection.
