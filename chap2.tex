...
OpenMC is also under development by NVIDIA themselves to be run on the GPU.  Progress was presented at the 2014 GPU Technology Conference (GTC) \cite{openmc_gtc}.
