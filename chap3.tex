...
After these failed attempts how to resolve the data heterogeneity problem, a method was formulated to eliminate the secondary energy search without having massive data replication.  This 

float4 can also be used here

Cross	secFons	are	
unionized	
?? Make	a	duplicate	table	
that	has	the	distribuFon	
pointer	at	that	energy	
?? Similar	to	a	linked	list!	
?? Only	triples	the	size	of	
the	cross	secFon	grid		
?? 1	copy	for	angular		
?? 1	copy	for	energy	
?? The	whole	table	is	
needed	anyway,	so	not	
unionizing	is	OK	
?? Only	opFon,	impact	will	
be	seen
...
The unionized cross section dataset is resident in the global memory 

constant memory, too small and not much improvement according to nelson (cache miss penalty)
...
does whole material, samples isotope
