...
As described in Chapter \ref{chap:background}, the nuclear data required in Monte Carlo simulations are very heterogeneous.  This section describes the methods used to deal with the data heterogeneity and how data access in WARP has been optimized for the GPU.
