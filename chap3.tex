...
All the necessary pieces to perform Monte Carlo neutron transport in general 3D geometries using continuous energy cross sections have been outlined.  Algorithms and libraries have been chosen so each step of neutron transport can be preformed efficiently on a GPU.  The next chapter will discuss the consequences of these choices and compare WARP's results and runtimes to those of Serpent and MCNP.
