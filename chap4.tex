...
\multicolumn{6}{|l|}{Homogenized Block }\\
\hline
 $k_\mathrm{eff}$ & 0.938223$\pm$0.0001 & 1.21414$\pm$0.0002 & 1.21346 & 1067 pcm (n) &  68 pcm (n)  \\
 \hline
 Runtime               & 236.9 m & 137.0 m & 2.8 m & 63.5x & 48.6x  \\
 \hline
  \hline
\multicolumn{6}{|l|}{Pin Cell}\\
\hline
...
\begin{table}[h]
\centering
\caption{Summary of $k_\mathrm{eff}$ single-run results of the WARP fixed-source benchmark with $4\times10^7$ total histories.}
\label{fixed_summary}
\begin{tabular}{| l | r | r | r | r | r |}
 \hline
