...
These effects are more clearly seen in the trends of Figure \ref{process_rate}.
...
not only to the specific reaction kernels benefit, but the main time svanings is in the global functions being able to reduce the size of their launches ( trace,  rng seeds (might be unecesary), scans, reductions, sorts) 
