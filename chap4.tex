...
Figure \ref{fixed_spec_water} shows the volume-averaged flux spectra produced by WARP, Serpent, and MCNP for the water fixed-source test.% Is there a connection between the two regions that could lead to some insight?  ? I'm not sure what you mean... what two regions?
