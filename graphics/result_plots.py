...
fig = pl.figure(figsize=(10,6))
ax = fig.add_subplot(1,1,1)
ax.semilogx(N_G650M,np.divide(N_G650M,G650M_interleaved_sbvh_prim 	),'r-',label='Interleaved - Sbvh, prim')
ax.semilogx(N_G650M,np.divide(N_G650M,G650M_interleaved_bvh_prim 	),'g-',label='Interleaved - Bvh,  prim')
ax.semilogx(N_G650M[:7],np.divide(N_G650M[:7],G650M_large_sbvh_prim[:7] 		),'b-',label='Large - Sbvh, prim')
ax.semilogx(N_G650M,np.divide(N_G650M,G650M_large_bvh_prim 	),'c-',label='Large - Bvh,  prim')
ax.semilogx(N_G650M,np.divide(N_G650M,G650M_assembly_sbvh_prim 		),'m-',label='Assembly - Sbvh, prim')
ax.semilogx(N_G650M,np.divide(N_G650M,G650M_assembly_bvh_prim 		),'y-',label='Assembly - Bvh,  prim')
...
ax.semilogx(N_G650M,np.divide(N_G650M,G650M_interleaved_sbvh_xfrm 	),'r--',label='Interleaved - Sbvh, xfrm')
ax.semilogx(N_G650M,np.divide(N_G650M,G650M_interleaved_bvh_xfrm	),'g--',label='Interleaved - Bvh,  xfrm')
ax.semilogx(N_G650M,np.divide(N_G650M,G650M_large_sbvh_xfrm			),'b--',label='Large - Sbvh, xfrm')
ax.semilogx(N_G650M,np.divide(N_G650M,G650M_large_bvh_xfrm 			),'c--',label='Large - Bvh,  xfrm')
ax.semilogx(N_G650M,np.divide(N_G650M,G650M_assembly_sbvh_xfrm		),'m--',label='Assembly - Sbvh, xfrm')
ax.semilogx(N_G650M,np.divide(N_G650M,G650M_assembly_bvh_xfrm 		),'y--',label='Assembly - Bvh,  xfrm')
...
fig = pl.figure(figsize=(10,6))
ax = fig.add_subplot(1,1,1)
ax.semilogx(N_k20,np.divide(N_k20,k20_interleaved_sbvh_prim 	),'r-',label='Interleaved - Sbvh, prim')
ax.semilogx(N_k20,np.divide(N_k20,k20_interleaved_bvh_prim 		),'g-',label='Interleaved - Bvh,  prim')
ax.semilogx(N_k20,np.divide(N_k20,k20_large_sbvh_prim 			),'b-',label='Large - Sbvh, prim')
ax.semilogx(N_k20,np.divide(N_k20,k20_large_bvh_prim 			),'c-',label='Large - Bvh,  prim')
ax.semilogx(N_k20,np.divide(N_k20,k20_assembly_sbvh_prim 		),'m-',label='Assembly - Sbvh, prim')
ax.semilogx(N_k20,np.divide(N_k20,k20_assembly_bvh_prim 		),'y-',label='Assembly - Bvh,  prim')
...
#ax.semilogx(N_k20,np.divide(N_k20,k20_interleaved_sbvh_xfrm 	),'r--',label='Interleaved - Sbvh, xfrm')
#ax.semilogx(N_k20,np.divide(N_k20,k20_interleaved_bvh_xfrm		),'g--',label='Interleaved - Bvh,  xfrm')
#ax.semilogx(N_k20,np.divide(N_k20,k20_large_sbvh_xfrm			),'b--',label='Large - Sbvh, xfrm')
#ax.semilogx(N_k20,np.divide(N_k20,k20_large_bvh_xfrm 			),'c--',label='Large - Bvh,  xfrm')
#ax.semilogx(N_k20,np.divide(N_k20,k20_assembly_sbvh_xfrm		),'m--',label='Assembly - Sbvh, xfrm')
#ax.semilogx(N_k20,np.divide(N_k20,k20_assembly_bvh_xfrm 		),'y--',label='Assembly - Bvh,  xfrm')
