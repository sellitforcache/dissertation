...
ax.semilogx(N_k20,np.divide(N_k20,k20_interleaved_sbvh_xfrm 	),'r--',marker='s',label='Interleaved - Sbvh, xfrm')
ax.semilogx(N_k20,np.divide(N_k20,k20_interleaved_bvh_xfrm		),'g--',marker='s',label='Interleaved - Bvh,  xfrm')
ax.semilogx(N_k20,np.divide(N_k20,k20_large_sbvh_xfrm			),'b--',marker='s',label='Large - Sbvh, xfrm')
ax.semilogx(N_k20,np.divide(N_k20,k20_large_bvh_xfrm 			),'c--',marker='s',label='Large - Bvh,  xfrm')
ax.semilogx(N_k20,np.divide(N_k20,k20_assembly_sbvh_xfrm		),'m--',marker='s',label='Assembly - Sbvh, xfrm')
ax.semilogx(N_k20,np.divide(N_k20,k20_assembly_bvh_xfrm 		),'y--',marker='s',label='Assembly - Bvh,  xfrm')
