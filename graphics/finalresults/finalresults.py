...
ax=fig.add_subplot(1,1,1)
w_len=12
ax.semilogx( ar_x, 'r',   label='Assembly,    Remapping')
ax.semilogx( an_x, 'b',   label='Assembly,    Non-Remapping')
ax.semilogx( hr_x, 'r--', label='Homogenized, Remapping')
ax.semilogx( hn_x, 'b--', label='Homogenized, Non-Remapping')
handles, labels = ax.get_legend_handles_labels()
ax.legend(handles,labels,loc=2)
